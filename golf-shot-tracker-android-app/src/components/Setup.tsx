    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-sm border border-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <select
              ...
              className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
            >
              {COURSES.map(c => (
                  ...
                  <button
                    ...
                    className={`flex-1 min-w-[100px] py-2 px-2 rounded-xl border transition-all flex flex-col items-center justify-center ${
                      selectedTee === tee.name
                        ? 'ring-2 ring-emerald-500 ring-offset-1 border-transparent shadow-sm'
          ...
          <div className="space-y-3">
            {players.map((player, idx) => (
              <div key={player.id} className="flex gap-3 items-start">
                <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center font-medium text-sm mt-2.5">
                  {idx + 1}
                </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-600">Play Mode</label>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-sm"
              >
          ...
          <div className="pt-2">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-slate-700 font-medium">Handicap Adjusted</span>
            </label>
            {handicapAdjusted && (
        ...
        {playMode === 'Teams' && numPlayers === 4 && (
          <section className="space-y-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
            <h2 className="text-lg font-medium text-slate-800 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3">
                <h3 className="font-medium text-emerald-700">Team A</h3>
                {players.map((p, idx) => (
              ...
              <div className="space-y-3">
                <h3 className="font-medium text-blue-700">Team B</h3>
                {players.map((p, idx) => (
                  <label key={p.id} className="flex items-center gap-2 text-sm">
                    <input
                      type="radio"
